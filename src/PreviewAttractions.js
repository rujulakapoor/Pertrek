...
//             this.setState({
//               attractions: [...this.state.attractions, attraction],
//             });
//           }
//         }.bind(this)
//       )
...
//   }
  ...
  save(attraction) {
    ...
    const db = Firebase.database().ref(
      "destinations/" + user + "/" + this.props.title
    );
    db.push(attraction).then((ref) => {
          ...
          <Carousel>
            {attractionList //COLLECTION NAME
              .filter(function (attractionito) {
                return (
                  Number.parseInt(attractionito.cost * partysizemultiple, 10) <
                    budget ||
              ...
              .map((attraction) => (
                <Carousel.Item>
                  ...
                  >
                    ...
                    <Card.Body>
                      <Card.Text as="h4">Cost: ${attraction.cost}</Card.Text>
                      <Card.Text as="h4">
                      ...
                      <Button
                        variant="secondary"
                        onClick={this.save.bind(this, attraction)}
                      >
                        Add
                      </Button>
                    </Card.Body>
                    <Card.Footer as="h4">{attraction.address}</Card.Footer>
                  </Card>
                </Carousel.Item>
              ))}
          </Carousel>
